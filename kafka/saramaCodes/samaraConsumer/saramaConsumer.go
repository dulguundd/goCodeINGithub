...
var (
	brokerList    = flag.String("brokers", "172.22.2.215:9093", "The comma separated list of brokers in the Kafka cluster")
	topic         = flag.String("topic", "go-comments", "REQUIRED: the topic to consume")
